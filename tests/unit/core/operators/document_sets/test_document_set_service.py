...
def storage(temp_duckdb_path):
    ...
    return DuckDBTableStorage(database_path=temp_duckdb_path)
...
class TestCreateDocumentSetService:
    ...
    def test_create_document_set_service(self, service, temp_duckdb_path):
    ...
    def test_create_document_set_sanitizes_table_name(self, service, temp_duckdb_path):
        """Test that table name is sanitized from document set name."""
        doc_set = service.create_document_set(
            name="My Documents 2024", description="Test", database_path=temp_duckdb_path
        )

        assert doc_set.table_name == "my_documents_2024"
...
class TestStoreData:
    ...
    def test_store_data(self, service, temp_duckdb_path, sample_table):
        ...
        updated = service.store_data(document_set_id=doc_set.id, data=sample_table)
    ...
    def test_store_data_creates_table(self, service, temp_duckdb_path, sample_table):
        ...
        service.store_data(document_set_id=doc_set.id, data=sample_table)

        # Verify table exists
        assert service.storage.table_exists(table_name=doc_set.table_name)
    ...
    def test_store_data_upserts(self, service, temp_duckdb_path):
        ...
        service.store_data(document_set_id=doc_set.id, data=initial_data)
        ...
        updated = service.store_data(document_set_id=doc_set.id, data=updated_data)
...
class TestPreviewData:
    ...
    def test_preview_data(self, service, temp_duckdb_path, sample_table):
        ...
        preview = service.preview_data(document_set_id=doc_set.id, limit=10, offset=0)
    ...
    def test_preview_data_with_limit(self, service, temp_duckdb_path, sample_table):
        ...
        preview = service.preview_data(document_set_id=doc_set.id, limit=2, offset=0)
    ...
    def test_preview_data_with_offset(self, service, temp_duckdb_path, sample_table):
        ...
        preview = service.preview_data(document_set_id=doc_set.id, limit=10, offset=1)
...
class TestComputeAndUpdateMetrics:
    ...
    def test_compute_and_update_metrics(self, service, temp_duckdb_path, sample_table):
        ...
        service.repository.update(document_set=doc_set)

        # Recompute
        updated = service.compute_and_update_metrics(document_set_id=doc_set.id)
...
class TestDeleteDocumentSetWithData:
    ...
    def test_delete_document_set_with_data(self, service, temp_duckdb_path, sample_table):
        ...
        # Delete with data
        result = service.delete_document_set(document_set_id=doc_set.id, delete_data=True)

        assert result is True
        assert not service.storage.table_exists(table_name=doc_set.table_name)
    ...
    def test_delete_document_set_preserve_data(self, service, temp_duckdb_path, sample_table):
        ...
        # Delete without data
        result = service.delete_document_set(document_set_id=doc_set.id, delete_data=False)
...
class TestTableNameSanitization:
    ...
    def test_sanitize_table_name_spaces(self, service):
        """Test sanitizing name with spaces."""
        result = service._sanitize_table_name("My Documents")
        assert result == "my_documents"

    def test_sanitize_table_name_special_chars(self, service):
        """Test sanitizing name with special characters."""
        result = service._sanitize_table_name("Test-Data (v1)")
        assert result == "testdata_v1"

    def test_sanitize_table_name_numbers(self, service):
        """Test sanitizing name with numbers."""
        result = service._sanitize_table_name("Documents 2024")
        assert result == "documents_2024"

    def test_sanitize_table_name_starts_with_number(self, service):
        """Test sanitizing name that starts with number."""
        result = service._sanitize_table_name("123 Documents")
        assert result == "tbl_123_documents"

    def test_sanitize_table_name_empty(self, service):
        """Test sanitizing empty name."""
        result = service._sanitize_table_name("")
        assert result == "tbl_"

    def test_sanitize_table_name_only_special_chars(self, service):
...
class TestGetDocumentSet:
    ...
    def test_get_document_set(self, service, temp_duckdb_path):
        ...
        retrieved = service.get_document_set(document_set_id=created.id)
...
class TestListDocumentSets:
    ...
    def test_list_document_sets(self, service, temp_duckdb_path):
    ...
    def test_list_document_sets_with_limit(self, service, temp_duckdb_path):
    ...
    def test_list_document_sets_with_offset(self, service, temp_duckdb_path):
...
class TestUpdateDocumentSet:
    ...
    def test_update_document_set(self, service, temp_duckdb_path):
