...
| **Security vulnerabilities** | Private disclosure of security issues | See [SECURITY.md](SECURITY.md) |
...
- **I found a security vulnerability** → Follow the process in [SECURITY.md](SECURITY.md). Do **not** open a public issue.
...
| Security vulnerability | 2 business days | Initial acknowledgement; see [SECURITY.md](SECURITY.md) |
...
- Handle privately-reported vulnerabilities per [SECURITY.md](SECURITY.md).
